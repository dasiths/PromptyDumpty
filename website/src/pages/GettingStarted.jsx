          ...
          <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-700">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p>Packages are installed to the correct directories for your detected agent, with files organized by artifact type (prompts, agents, rules, etc.) and package name for easy management.</p>
              </div>
            </div>
          </div>
