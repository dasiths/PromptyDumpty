...
class TestUninstallCommand:
    ...
    def test_uninstall_agent_not_installed_for(self, cli_runner, setup_installed_package, monkeypatch):
    ...
    def test_uninstall_with_already_deleted_files(self, cli_runner, setup_installed_package, monkeypatch):
    ...
    def test_uninstall_multiple_files(self, cli_runner, tmp_path, monkeypatch):
        ...
        package = InstalledPackage(
            ...
            files={
                "copilot": [
                    InstalledFile(source="f1.md", installed=".github/multi-file/file1.md", checksum="sha256:1"),
                    InstalledFile(source="f2.md", installed=".github/multi-file/file2.md", checksum="sha256:2"),
                    InstalledFile(source="f3.md", installed=".github/multi-file/subdir/file3.md", checksum="sha256:3"),
                ]
            },
            manifest_checksum="sha256:def456",
        )
    ...
    def test_uninstall_preserves_other_packages(self, cli_runner, tmp_path, monkeypatch):
        ...
        for i in [1, 2]:
            package = InstalledPackage(
                ...
                files={
                    "copilot": [
                        InstalledFile(source="f.md", installed=f".github/package{i}/file.md", checksum="sha256:1")
                    ]
                },
                manifest_checksum="sha256:def456",
            )
