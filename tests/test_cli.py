...
class TestInstallCommand:
    ...
    def test_install_requires_manifest(self, cli_runner, tmp_path, monkeypatch):
        ...
        from dumpty.downloader import FileSystemGitOperations
...
"""
    ...
    def test_install_package_not_supporting_agent(self, cli_runner, tmp_path, monkeypatch, sample_package_dir):
